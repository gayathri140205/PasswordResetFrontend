...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('https://password-reset-6yg8.onrender.com/signup', {
        method: 'POST',
        headers: {
  ...
  return (
    <div className="container mt-5">
      <form onSubmit={handleSubmit} className="fw-bold text-white form-container">
        ...
        <button type="submit" className="btn btn-submit w-50 fw-bold btn-primary" style={{ backgroundColor: '#182C34D1', color: 'white', borderRadius: '5px', border: 'none', padding: '10px 20px', cursor: 'pointer' }}>
            {loading ? (
